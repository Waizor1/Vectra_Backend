...
async def notify_auto_renewal_failure(user, reason: str = "Неизвестная ошибка", will_retry: bool = True):
    ...
    if lang == 'ru':
        text = (
            ...
            "Продлите вручную в личном кабинете или обратитесь в поддержку @BloopCat_supbot."
        )
        ...
        text = (
            ...
            "Please renew manually in your dashboard or contact support @BloopCat_supbot."
        )
