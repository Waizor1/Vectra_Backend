...
async def notify_expiring_trial(user):
    ...
    if lang == 'ru':
        text = (
            f"⚠️ Привет, {user.full_name}! Ваш пробный период TVPN истекает сегодня ночью (в 00:00). \n"
        ...
        text = (
            f"⚠️ Hi {user.full_name}! Your TVPN trial period will expire tonight (at 00:00). \n"
