...
class NotificationMarks(models.Model):
    ...
    type = fields.CharField(max_length=64, description="Notification category, e.g., trial_no_sub, referral_prompt")
    key = fields.CharField(max_length=64, null=True, description="Sub-key, e.g., 2h, 24h, 7d, 14d, 30d")
