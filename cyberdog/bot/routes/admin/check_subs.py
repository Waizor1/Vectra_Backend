...
from cyberdog.bot.routes.admin.functions import IsAdmin, search_user
from cyberdog.schedules import check_subscriptions, check_trial_users
from cyberdog.routes.marzban.catcher import marzban_updater
from cyberdog.processing.user_processor import reset_expired_users, process_user
...
async def admin_send_renewal_notice(message: Message):
    ...
    try:
        ...
        from cyberdog.bot.notifications.user import notify_auto_payment
